...
import { LOGIN_RESET } from "../constants/Auth";
...
const Login = () => {
  ...
  const [trans, setTras] = useState(0);
  ...
  if(trans>0){
    toast.success('OTP is sent to given Email');
    navigate('/rest',{state:email})
  }
  return (
    <>
      <div className="h-[102vh] flex">
        <div className="right h-[96%] max-[960px]:hidden w-[50%] mt-[25px] max-[948px]:relative max-[948px]:top-[10px] max-[948px]:min-h-[35vh] flex flex-col justify-center items-center">
          <Tilt
          ...
          >
            <div className="card w-96 bg-[#0d0d0d] shadow-xl m-[10px]  hover:shadow-blue-500/30 rounded-xl">
              <div className="card-body">
                ...
                <p className="text-blue-400 text-lg mt-[10px] font-semibold">
          ...
          >
            <div className="card w-96 bg-[#0d0d0d] shadow-xl m-[10px]  hover:shadow-red-300/30 rounded-xl">
              <div className="card-body">
                ...
                <p className="text-[#ef476f] text-lg mt-[10px] font-semibold">
                  Apply : Build , Play and Create
                </p>
              </div>
            </div>
          </Tilt>
          ...
          >
            <div className="card w-96 bg-[#0d0d0d] shadow-xl m-[10px]  hover:shadow-green-300/30 rounded-xl">
              <div className="card-body">
                ...
                <p className="text-[#23c45c] text-lg mt-[10px] font-semibold">
        ...
        <div className="left w-[50%] flex justify-center items-center max-[948px]:h-[100vh] max-[948px]:w-[100%] max-[948px]:relative ">
          <div className="h-[90%] hover:shadow-blue-500 w-[70%] shadow-lg rounded-2xl flex flex-col [@media(max-width:1100px)]:w-[89%] bg-[#16171c] ">
            <h1 className="min-[950px]:text-[49px] top-8 relative w-[100%] text-center font-semibold h-[100px] min-[950px]:pt-[10px]  [@media(max-width:948px)]:text-[40px] max-[500px]:font-bold">
              Login
            </h1>
            <ToastContainer theme="dark" />
            <div className="flex justify-center items-center  h-[90%] min-[950px]:mt-[12px] flex-col gap-[15px]">
              <div>
                <form action="" onSubmit={loginSubmit}>
                  ...
                  <div className="h-[30px]  w-[100%] text-center text-[23px] "></div>
                  <div className="w-[100%] justify-center flex max-[948px]:relative flex-col ">
                    <button
                      type="submit"
                      className="min-[950px]:h-[40px] min-[950px]:w-[300px] bg-blue-500 text-white rounded-3xl  max-[948px]:w-[57vw] max-[948px]:h-[39px]"
                    >
                      Login
                    </button>
                  </div>
              ...
              <div>
                <button
                  className="btn text-center bg-[#16171c] mt-[15px] hover:text-blue-500 text-blue-300 text-[18px] cursor-pointer"
                  onClick={() =>
                ...
                >
                  <div className="modal-box">
                    <div className="flex justify-center flex-col">
                      <h1 className="w-[100%] text-center text-[20px] mb-[10px]">Enter the Email For OTP </h1>
                      <textarea
                        type="text"
                        value={email}
